...
class SubWindow3(QMainWindow):
    def __init__(self):
        ...
        # Label
        self.label_31.setText("NO_DTC")
        self.label_31.setStyleSheet("background-color: lightgreen")
        self.label_29.setText("Active")
        self.label_29.setStyleSheet("background-color: red")
        
        #Button
        self . Close . clicked . connect ( self . Close_window )
        self . clear_DTC . clicked . connect ( self . Clear_DTC )
