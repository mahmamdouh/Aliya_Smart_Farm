...
from Sys_Data import HVAC_sys_sts , Get_Date, Room_temp_sts ,time_to_sleep , Ammonia_sts  ,previous ,worksheet , Excel_data_frame ,Operator_HVAC_sys_sts ,Head_count_sts ,Window_2_status ,Day_12_hour,Update_12hur,sys_status,Air_sts,Data,Limits
#from google_spreadsheet import Google_sheet_send_data ,Google_Sheets_Runnable
from DTC import *
from Configer import config_Update_data
...
class  MatplotlibWidget ( QMainWindow ):
    ...
    def Open_Scaler_window(self):
        self.Scaler_Wind1.showFullScreen()
        
    def Open_Setting_window(self):
        self.Setting1.showFullScreen()

    def Open_DTC_window(self):
        self.DTC_Window1.showFullScreen()
...
class Setting(QMainWindow):
    ...
    def Close_window(self):
        ...
        Data["Updte_Flag"] = 1
        Data_List.append("Aliya - Smart Farm")
        Data_List.append(str(date.today()))
        Data_List.append(Data["Age"])
        Data_List.append(Data["Head_Cnt"])
        Data_List.append(Data["Temp_UP"])
        Data_List.append(Data["Temp_LW"])
        Data_List.append(Data["Ammonia_L"])
        Data_List.append(Data["Updte_Flag"])
        config_Update_data(Data_List)
        self.close()
