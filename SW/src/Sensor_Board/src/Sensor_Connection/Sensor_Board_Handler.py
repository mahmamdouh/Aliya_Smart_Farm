...
print("ammonia ==================================")
x,y,Air_Quality =Sensor_Board_Handler_Runnable([1,7],"Ammonia")
values = Air_Quality.values()
total = sum(values)
print("total ammonia" ,total )

print("Air ==================================")
x,y,ammonia_Quality =Sensor_Board_Handler_Runnable([1,7],"AIR")
values = ammonia_Quality.values()
total = sum(values)
print("total Air" ,total )

print("Tmp Humid ==================================")
x,y,ammonia_Quality =Sensor_Board_Handler_Runnable([1,7],"Normal")
values = x.values()
totalx = sum(values)
values = y.values()
totaly = sum(values)
print("total temp" ,totalx )
print("total Humid" ,totaly )
