...
def App_Main():
    ...
    if Temprature != 0:
        ...
        Excel_Data_Handler()
    HVAC_Handler()
    print("Day_Change flag=",Day_Change_Flag["Flag"])
    if (Day_Change_Flag["Flag"]):
        Day_Change_Flag["Flag"] = 0
        print("Day changed =====================================")
        Room_temprate=[]
        time_slice=[]
        min_Temp_limit_stamp=[]
